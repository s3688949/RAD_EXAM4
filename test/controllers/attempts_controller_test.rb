...
class AttemptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attempt" do
    assert_difference('Attempt.count') do
      post attempts_url, params: { attempt: { category: @attempt.category, correct: @attempt.correct, difficulty: @attempt.difficulty, questions: @attempt.questions, time: @attempt.time } }
    end
  ...
  test "should update attempt" do
    patch attempt_url(@attempt), params: { attempt: { category: @attempt.category, correct: @attempt.correct, difficulty: @attempt.difficulty, questions: @attempt.questions, time: @attempt.time } }
